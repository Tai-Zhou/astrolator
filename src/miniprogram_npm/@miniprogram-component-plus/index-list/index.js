                ...
                Component({
                    ...
                    methods: {
                        ...
                        _scrollTo: function _scrollTo(e) {
                            ...
                            var index = Math.max(0, Math.min(data.alphabet.length - 1, Math.floor((clientY - data._anchorTop) / data._anchorItemH)));
                            if (data.vibrated && this.data.current != data.alphabet[index]) wx.vibrateShort();
                        ...
                        _onScroll: function _onScroll(e) {
                            ...
                            if (data.vibrated && this.data.current != current)
                                wx.vibrateShort()
